...
const WORK_LOCATION = {
  ...
  children: [
    ...
    },
    {
      ...
      windowPosition: "top-65 left-10",
      children: [
        {
          id: "work-oss-0",
          name: "React Big Schedule.txt",
          icon: "/images/txt.png",
          kind: "file",
          fileType: "txt",
          position: "top-5 left-5",
          subtitle: "React Big Schedule — Open Source Scheduling Library",
          tech: [
            "React",
            "JavaScript",
            "CSS",
          ...
          description: [
            "Created React Big Schedule, an open-source scheduling and resource planning library for React applications.",
            "Designed flexible calendar and scheduling components supporting drag-and-drop interactions and multiple view modes.",
            "Library is actively used in production projects and receives ongoing community contributions.",
            "Currently maintaining the project in stability mode, focusing on issue triage, code reviews, and merging pull requests.",
            "Ensure backward compatibility, dependency updates, and release management to keep the library reliable over time.",
          ],
        },
      ],
    },
